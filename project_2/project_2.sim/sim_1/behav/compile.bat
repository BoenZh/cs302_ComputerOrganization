...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot mux_testbench_behav --prj X:/CSCE302/aaa/project_2/project_2.sim/sim_1/behav/mux_testbench.prj   xil_defaultlib.mux_testbench
if errorlevel 1 (
